...
<CardGroup cols={2}>
  <Card title="Document Library" icon="folder-open" href="/essentials/library">
    Learn how to use the document library in Hiro
  </Card>
  <Card title="Staff Permissions" icon="user-lock" href="/essentials/permissions">
