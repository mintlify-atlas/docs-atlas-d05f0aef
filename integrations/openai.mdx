...
<CardGroup cols={2}>
  <Card title="Customer Analytics" icon="chart-mixed" href="/essentials/analytics">
    Learn what data the AI can analyze
  </Card>
  <Card title="Campaign Builder" icon="bullhorn" href="/essentials/campaigns">
    Use AI suggestions to create campaigns
  </Card>
</CardGroup>
